package basic.arch.component.http.common;
...
import basic.arch.component.http.builder.HACB;
import basic.arch.component.http.builder.HCB;
import basic.arch.component.http.client.HttpAsyncClientUtil.IHandler;
...
public class HttpConfig {
     ...
     */
    public static final ThreadLocal<OutputStream> outs = new ThreadLocal<OutputStream>();
    //	/**
    //	 * 输出流对象
    //	 */
