package basic.arch.component.exception.api;

import org.springframework.core.task.TaskExecutor;

import basic.arch.component.exception.UnifiedException;
import basic.arch.component.exception.handler.ExceptionHandlerChain;
...
public class ExceptionManager implements IExceptionManager{
    ...
    @Override
    public void publish(String description, String businessModule, String errorCode, Throwable throwable) {
        GlobalInfo gi = new GlobalInfo(systemCode, systemName,exceptionHandleExecutor);
        UnifiedException ue = new UnifiedException(description,businessModule,errorCode,throwable);
        accept(ue, gi);
    }
    
    @Override
    public void publish(String description,String errorCode,Throwable throwable) {
        GlobalInfo gi = new GlobalInfo(systemCode, systemName,exceptionHandleExecutor);
        UnifiedException ue = new UnifiedException(description,errorCode,throwable);
        accept(ue, gi);
    }
    ...
    public void publishSerious(String description, String businessModule, String errorCode) {
        GlobalInfo gi = new GlobalInfo(systemCode, systemName,exceptionHandleExecutor);
        UnifiedException ue = new UnifiedException( description, businessModule, errorCode,null);
        accept(ue,gi);
    }
