...
public abstract interface IExceptionManager {
     ...
     */
    public abstract void publish(String description,String businessModule,String errorCode,Throwable throwable);
      ...
      * @param throwable the throwable which caused this UnifiedException<br>
      */
     public abstract void publish(String description,String errorCode,Throwable throwable);
