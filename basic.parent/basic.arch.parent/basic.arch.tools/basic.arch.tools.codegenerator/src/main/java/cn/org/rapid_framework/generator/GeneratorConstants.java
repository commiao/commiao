...
public enum GeneratorConstants {
    ...
    //add start by jannal 2015-09-29
    BASE_DIR("basedir",null,"根目录"),
    FILE_OUT_ROOT("outRoot","c:\\code","生成的输出文件目录"),
    
    TEMPLATE_ROOT("templateRootDirs",null,"模板文件目录"),
   //add end by jannal 2015-09-29
