 ...
 * 
 */
public class SfActivity  implements Serializable  {
	...
	public String getStartDateString() {
	  return DateUtils.formatDateToString(getStartDate(), "yyyy-MM-dd HH:mm:ss");
	}
	public void setStartDateString(String startDateStr) {
	  setStartDate(DateUtils.parse(startDateStr, "yyyy-MM-dd HH:mm:ss"));
	}
	...
	public String getEndDateString() {
	  return DateUtils.formatDateToString(getEndDate(), "yyyy-MM-dd HH:mm:ss");
	}
	public void setEndDateString(String endDateStr) {
	  setEndDate(DateUtils.parse(endDateStr, "yyyy-MM-dd HH:mm:ss"));
	}
	...
	public String getApplyEndDateString() {
	  return DateUtils.formatDateToString(getApplyEndDate(), "yyyy-MM-dd HH:mm:ss");
	}
	public void setApplyEndDateString(String applyEndDateStr) {
	  setApplyEndDate(DateUtils.parse(applyEndDateStr, "yyyy-MM-dd HH:mm:ss"));
	}
