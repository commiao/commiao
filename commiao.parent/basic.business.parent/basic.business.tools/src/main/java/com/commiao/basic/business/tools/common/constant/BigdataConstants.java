...
public class BigdataConstants {
    ...
    /**统一是否状态码 0.否*/
    public final static String COMMON_WHETHER_NO = "0";
    /**统一是否状态码 1.是*/
    public final static String COMMON_WHETHER_YES = "1";
    ...
    public final static String POF_SESSION_USER_KEY = "pof_session_user";
    ...
    //预约理财师短信码
    public final static String VERIFY_CODE_PHONE_16 = "16";
...
//  邮箱认证成功文案：恭喜！您已成功完成邮箱认证！
     ...
     * 默认空值
     */
    public final static String APP_DEFAULT_NULL = "";
    ...
    public final static String ELECTRONIC_CONTRACT_RET_MSG_ERROR_1 = "电子合同服务调用失败，请您稍后再试";
    /**电子合同获取验证码失败 - 合格投资者审核中，审核不通过或者未提交，无法进行电子合同签署*/
    public final static String ELECTRONIC_CONTRACT_RET_CODE_NOT_QUALIFY_INVESTOR = "1";
    public final static String ELECTRONIC_CONTRACT_RET_MSG_NOT_QUALIFY_INVESTOR = "合格投资者审核中，审核不通过或者未提交，无法进行电子合同签署";
    /**电子合同获取验证码失败 - 非电子合同产品，不能签署电子合同*/
    public final static String ELECTRONIC_CONTRACT_RET_CODE_NOT_ELECONTRACT_PRODUCT = "2";
    public final static String ELECTRONIC_CONTRACT_RET_MSG_NOT_ELECONTRACT_PRODUCT = "非电子合同产品，不能签署电子合同";
    /**电子合同返回状态-成功**/
    public final static String ELECTRONIC_CONTRACT_RET_CODE_SUCCESS = "0000";
    /**金服后台是否启动  1.启用*/
    public final static int JF_ISENABLES_ENABLES = 1;
    /**是否过滤日志中敏感信息0.否 1.是*/
    public final static String IS_FILTER_LOG = "1";
	...
	public static class FinancialPlannerConstant {
		...
		// 北京对应的城市编码
		public static final String BEIJING = "001";
		...
		/** 是否为专属理财师 1.是 */
		public static final String BROKER_IS_MAIN_NO = "0";
		// 理财师排序
		public static final String ACCOUNTANTORDER = "accountantOrder";
		// 推荐理财师
		public static final String ACCOUNTANTRECOMMEND = "accountantRecommend";
	}
     ...
     * @version V1.0
     */
    public static class CommunityActivityConstant{
        //活动预热中 是
        public static final String CA_WARMUP_YES_CODE = "1";
        //活动预热中 否
        public static final String CA_WARMUP_NO_CODE = "0";
        //活动开启报名中 是
        public static final String CA_OPENSERVER_YES_CODE = "1";
        //活动开启报名中 否
        public static final String CA_OPENSERVER_NO_CODE = "0";
    }
    ...
    public static class UserinfoForAccoutConstant{
        ...
        /**1表示是风险测评的问卷--目前只有此值,is_risk默认值为1*/
        public static final String IS_RISK = "1";
        /**paper_id获取问卷,-1代表个人，-4代表机构*/
        public static final String PAPER_ID_1="182";
        public static final String PAPER_ID_4="162";
//        public static final String PAPER_ID_1="-1";
//        public static final String PAPER_ID_4="-4";
...
//    	public static final String JF_REDEMPTION_TIME_END = "15:00:00";
	...
	public static class ProductInfoConstant{
		...
		/**产品预约状态 2.已过期*/
		public static final String PRODUCT_ORDER_STATUS_SECOND = "2";
		/**产品预约状态 7.排队成功*/
		public static final String PRODUCT_ORDER_STATUS_SEVEN = "7";
		/**产品预约状态 f.待确认*/
		public static final String PRODUCT_ORDER_STATUS_F = "f";
		/**产品预约状态 e.已赎回*/
		public static final String PRODUCT_ORDER_STATUS_REDEMPTION  = "e";
		/**营销项目状态 1.待发行*/
		...
		/**是否稳金电子合同  0.是*/
		public static final String PRODUCT_IS_ELECONTRACT_YES = "0";
		/**是否稳金电子合同  1.否*/
		public static final String PRODUCT_IS_ELECONTRACT_NO = "1";
		/**产品重复预约*/
    	public static final String PRODUCT_RESERVE_RESUBMIT = "PF9999";
    	/**产品重复预约文案*/
    	public static final String PRODUCT_RESERVE_RESUBMIT_MSG = "您已完成过一次预约，请勿重复提交";
        /**是否需要判断投资者分类标签  2.是*/
        public static final String PRODUCT_IS_INVESTCLASSIFY_REQUIRED_YES = "2";
        /**是否需要判断投资者分类标签  1.否*/
        public static final String PRODUCT_IS_INVESTCLASSIFY_REQUIRED_NO = "1";
        
        /**产品材料查询 file_type 1.(简版)产品材料*/
        public static final String PRODUCT_ATTACHMENT_INTRODUCTION = "1";
        /**产品材料查询 file_type 10.售前风险告知书*/
        public static final String PRODUCT_ATTACHMENT_WARNING = "10";
	}
	...
	public class InvestorClassify{
		/**投资者分类 ：1.待审核*/
		public static final String HS_AUDITSTATUS_WAIT = "1";
		/**投资者分类 ：1.待审核 转义*/
		public static final String HS_AUDITSTATUS_WAIT_DESC = "待审核";
		/**投资者分类 ：2.审核通过*/
		public static final String HS_AUDITSTATUS_PASS = "2";
		/**投资者分类 ：3.审核驳回*/
		public static final String HS_AUDITSTATUS_REJECT = "3";
		/**上传附件业务类型：0.合格投资者认定*/
		public static final String UPLOAD_FILE_TYPE_QUALIFY = "0";
		/**上传附件业务类型：1.投资者分类*/
		public static final String UPLOAD_FILE_TYPE_INVESTORS = "1";
		/**1.普通投资者*/
		public static final String HS_INVESTORS_CLASSIFY_GENERAL = "1";
		/**0.专业投资者*/
		public static final String HS_INVESTORS_CLASSIFY_MAJOR = "0";
		/**用户信息查询中投资者分类标识 0.普通投资者*/
		public static final String HS_USER_INVESTORS_CLASSIFY_GENERAL = "0";
	}
	
	/**
     * banner 需要将链接域名替换为本服务器域名的类型
     */
	public class adPositionForRep{
	    public static final String ADPOSITIONLIST = "topicFeature,appWapIndextop";
	}
	
	/**
	 * CreateDate:2017年9月11日下午5:03:16 
	 * @Description: 预约理财师发送短信scenarios 
	 * @author:zw
	 * @version V1.0
	 */
	public class SmsMessageTemplates{
		//业务场景-预约理财师
		public static final String SMS_BESPOKE_BROKER="sms_bespoke_broker";
		//业务场景-绑定服务理财师(未实名认证)
		public static final String SMS_BINDING_BROKER="sms_binding_broker";
		//业务场景-绑定服务理财师(已实名认证)
		public static final String SMS_BINDED_BROKER="sms_binded_broker";
	}
}
