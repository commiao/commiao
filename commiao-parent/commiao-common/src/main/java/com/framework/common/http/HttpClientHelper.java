...
public class HttpClientHelper {
    ...
    public static void main(String[] args) throws Exception {
        String url = "http://---/ds/x2/f00qvewaxsqdnrzazhhyguhduc7wd8sv.png";
        InputStream inputStream = HttpClientHelper.httpGetStream(url, null);
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(new File("/test22222.png"));
            while (true) {
