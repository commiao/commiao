package com.framework.common.json.org;
...
public class JSONUtil{
	...
	JSONStringObject getJSONObject(Object value, boolean useClassConvert) throws JSONException{
        ...
        if (value instanceof Timestamp){
        	String str =DateTimeUtils.formatDate((Timestamp)value,  "yyyy-MM-dd HH:mm:ss");
            return new JSONStringObject(JSONObject.quote(str));
        }
        if (value instanceof Date){
        	String str = DateTimeUtils.formatDate((Date)value, "yyyy-MM-dd HH:mm:ss");
            return new JSONStringObject(JSONObject.quote(str));
        }
