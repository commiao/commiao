...
.btn_next {
    background: url("${base}/resources/csimages/btn_next.jpg") no-repeat scroll 0 0 transparent;
    border: 0 none;
    height: 33px;
    width: 106px;
}
...
function sub(){
		if(checkEmail_pwd()){
			var url = "${base}/password/isEmailExist";
...
<script type="text/javascript">
  ...
  <em class="reg_tit f14 fw">亲爱的用户 ${nickname},这里是重置密码邮件激活。</em>
  	...
  	<div style="font-size: 25px;">您好，<span style="font-size: 25px;" id="uname">${nickname}</span><br/></div>
  	...
  	<p>&nbsp;</p>
  	<image id="mail_btn" src="${base}/resources/csimages/getMail.png" style="cursor:pointer" onclick="mailUrl(this)" /> 
  	<a href="javascript:login();">返回登录</a>
  	</div>
