...
public class MobileVerifyCode {
	private static Logger logger = LoggerFactory
			.getLogger(MobileVerifyCode.class);
	 ...
	 * @return
	 */
	public boolean validate(String referrer, String phoneVCode,
			String destMobileNum) {
		...
		if (this.referrer != null && referrer != null) {
			if (this.referrer.equals(referrer)
					&& this.phoneVCode.equals(phoneVCode)
